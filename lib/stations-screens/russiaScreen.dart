...
class RussiaScreen extends StatelessWidget {
  static const routeName = '/russia-screen';
          ...
          children: <Widget>[
            ...
            Column(
              children: <Widget>[
                ...
                Center(
                  child: RadioWidget(Stations.russiaStation, "Russia"),
                ),
              ],
            ),
          ],
